...
<title>Second DIVE - noticeUpdate</title>
<script>
	'use strict';
...
<div class="rightSide">
	...
	<form name="noticeUpdateForm" method="post">
		<table class="table">
			<tr>
				<th>제목</th>
				<td><input type="text" name="noticeTitle" id="noticeTitle" value="${vo.noticeTitle}" class="form-control" /></td>
			</tr>
			<tr>
				<th>내용</th>
	      <td><textarea name="noticeContent" id="CKEDITOR" rows="6" class="form-control" required>${vo.noticeContent}</textarea></td>
	      <script>
		...
		<button onclick="noticeUpdate()" class="btn btn-info" style="float: right; margin-right: 10px;">전체공지수정</button>		
