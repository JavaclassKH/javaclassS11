...
<body>
	<div id="before">
		<div>
			...
			<a href="${ctp}/play/quizMain" class="btn btn-dark ml-4">퀴즈파크</a>
			</div>
		</div>
	</div>
	<div id="start" style="display: none;">
		...
		<div class="text-center">
			...
			<button onclick="answerCheck('${quizbogi[0]}')" id="b1" class="btn btn-light mb-4">${quizbogi[0]}</button><br/>
			<button onclick="answerCheck('${quizbogi[1]}')" id="b2" class="btn btn-light mb-4">${quizbogi[1]}</button><br/>
			<button onclick="answerCheck('${quizbogi[2]}')" id="b3" class="btn btn-light mb-4">${quizbogi[2]}</button><br/>
